...
namespace hardware_tycoon_api.Simulation
{
    public static class Core
    {
        ...
        public static readonly Dictionary<string, ResearchProject> ResearchProjects = new()
        {
            ...
            ["A2"] = new ResearchProject { Name = "A2", Price = 10, Description = "A2 requires A and unlocks nothing" },
            ["B2"] = new ResearchProject { Name = "B2", Price = 20, Description = "B2 requires B and unlocks nothing" },
            ["C2"] = new ResearchProject { Name = "C2", Price = 40, Description = "C2 requires C and unlocks nothing" },
